    ...
    <div className="relative bg-white rounded-[1rem] mb-[1.5rem] p-4 ">
      ...
      <div className="">
        <div className="w-full flex justify-between mt-2">
          <h1 className=" text-[1.2rem] font-bold">Noi cai quan que gi do</h1>
          <svg
        ...
        <div className="flex items-center mt-1">
          ...
          <span className="text-[14px] font-400 text-left font-500">
            <span className="text-black text-[0.8rem] font-bold">23</span>{' '}
            <span className="font-[400] text-[0.8rem]"> 9000km form</span>
          </span>
        </div>
      </div>
    </div>
