  ...
  return (
    <div className={`fixed top-0 z-20 w-full transition-all ${open ? "" : "border-b-2"}`}>
        <nav className='relative px-10 py-3  flex items-center lg:justify-between md:justify-between sm:justify-center mb:justify-center'>
          {/* LEFT */}
        <div className='logo  lg:block  md:hidden sm:hidden mb:hidden'><img className='w-[130px] h-[35px]' src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/69/Airbnb_Logo_B%C3%A9lo.svg/2560px-Airbnb_Logo_B%C3%A9lo.svg.png" alt="" /></div>
        {/* END LEFT */}
